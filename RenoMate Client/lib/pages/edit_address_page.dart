...
import 'package:renomateclient/controllers/edit_address_page_controller.dart';
import 'package:renomateclient/models/address_model.dart';
import 'package:renomateclient/theme.dart';

class EditAddressPage extends StatelessWidget {
  EditAddressPage({super.key});

  final EditAddressPageController controller =
      Get.put(EditAddressPageController());
